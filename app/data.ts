...
export const brainstormItems: BrainstormItem[] = [
  ...
  { num: 22, item: "Document Paperclip SOP", category: "Paperclip", status: "partial", evidence: "PAPERCLIP.md created, detailed SOP pending ClawForge workflow" },
  { num: 23, item: "Document Paperclip utilization", category: "Paperclip", status: "partial", evidence: "Discord thread + PAPERCLIP.md cover basics, formal doc pending" },
